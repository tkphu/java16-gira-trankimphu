package cybersoft.javabackend.java16giratrankimphu.security.controller;
...
import cybersoft.javabackend.java16giratrankimphu.security.service.AuthService;
...
public class AuthController {
	...
	public Object login(@RequestBody @Valid LoginDTO dto, BindingResult bindingResult) {
		...
		if (token == null) {
			return ResponseHelper.getErrorResponse("Password is not true", HttpStatus.BAD_REQUEST);
		}else {
